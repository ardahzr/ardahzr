...
<a href="https://github.com/ardahzr?tab=repositories">Public Projects</a>
 · 
<a href="https://github.com/ardahzr?tab=stars">Interests</a>
 · 
...
<table>
  <tr>
    <td width="50%">
      <h3><a href="https://github.com/ardahzr/Licord">Licord</a></h3>
      <p>Native Discord-inspired voice and group chat app focused on speed and a lighter desktop experience.</p>
      <p><sub>Tauri · Rust · TypeScript</sub></p>
    </td>
    <td width="50%">
      <h3><a href="https://github.com/ardahzr/acibadem-ai-chat">ACU AI Chatbot</a></h3>
      <p>Local AI chatbot for Acibadem University, built around an open-source LLM workflow.</p>
      <p><sub>Django · PostgreSQL · Ollama</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3><a href="https://github.com/ardahzr/Learning-and-Program-Outcome-Management">Program Outcome Manager</a></h3>
      <p>Academic outcome management app for calculating learning and program outcome scores from course grades.</p>
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <p>YOLOv8x-Pose based scoliosis detection experiment for analyzing spinal curvature.</p>
      <p><sub>Python · YOLOv8 · Computer Vision</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3><a href="https://github.com/ardahzr/epias-load-forecasting">EPIAS Load Forecasting</a></h3>
      <p>Electricity load forecasting pipeline for Turkish EPİAŞ consumption data with weather features and ensemble models.</p>
      <p><sub>Python · LightGBM · XGBoost · PatchTST</sub></p>
    </td>
    <td width="50%">
...
<p>
  ...
  <img alt="YOLO" src="https://img.shields.io/badge/YOLO-111827?style=for-the-badge&logoColor=white">
</p>
